...
-- admin note: it doesn't look like xmpp-client
-- (https://github.com/agl/xmpp-client) supports hashed logins; at this time,
-- internal_plain will be used.
